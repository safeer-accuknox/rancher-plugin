...
import { getDisplayName, isIpV4, isIpV6, getI18Name } from './common';
import { getRowBasedPermission } from './auth';
...
export async function combineSecurityEvents(securityEventsData: any, store: any, selectedRow: any) {
    ...
    console.log('Security Events1 (raw): ', [
        threatList,
        violationList,
        incidentList,
    ]);
